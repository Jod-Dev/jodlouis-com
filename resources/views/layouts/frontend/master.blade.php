...
<body class="@if (request()->is('/')) home
             ...
             @endif
@if(Session::get('choose_version_key') != null)
@if(Session::get('choose_version_key') == 1)
        light
        @endif
@else
...
<header class="header" id="navbar-collapse-toggle">
    ...
    <ul class="icon-menu d-none d-lg-block revealator-slideup revealator-once revealator-delay1">
        ...
        @endif
        @if ($section_arr['homapage_version_button'] == 1)
            <li class="icon-box">
                <i class="fa fa-palette"></i><a  data-toggle="modal" data-target="#versionModal">
                    <h2>{{ __('frontend.color') }}</h2>
                </a>
            </li>
        @endif
    </ul>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title custom-text-light" id="versionModalLabel">{{ __('frontend.theme_customization') }}</h5>
                ...
                <form action="{{ route('home.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="hiddenradio">
                                    <label>
                                        <input type="radio" name="choose_version" value="0">
                            ...
                            <div class="col-md-6">
                                <div class="hiddenradio">
                                    <label>
                                        <input type="radio" name="choose_version" value="1">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary mx-auto d-block">{{ __('frontend.choose_color') }}</button>
                    </div>
                </form>
            </div>
        </div>
